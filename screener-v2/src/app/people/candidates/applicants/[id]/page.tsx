...
function ApplicantTabs({
  ...
  function tabHref(key: ApplicantTab): Route {
    ...
    return `/people/candidates/applicants/${applicationId}${q ? `?${q}` : ""}` as Route;
  }
...
export default async function ApplicantReviewPage({
  ...
  const activeApplication =
    candidate.applications.find((a) => a.id === id) ??
                  ...
                  {detail.screeningAddonResults.map((addon, index) => (
                    ...
                    >
                      ...
                      <div className="grid gap-3 border-t border-[color:var(--app-border)] pt-3 sm:grid-cols-4">
                        ...
                        <ScoreCell label="Score" value={formatPercent(addon.applicantPercent)} />
                        <ScoreCell
                          label="Points"
