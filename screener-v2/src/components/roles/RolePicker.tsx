    ...
    <div className={className}>
      ...
      {managerOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-950/72 p-4 backdrop-blur-sm">
          <div className="w-full max-w-5xl rounded-[28px] border border-white/12 bg-[linear-gradient(180deg,rgba(22,27,40,0.98),rgba(14,19,30,0.98))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <h3 className="text-xl text-white">Manage roles</h3>
                <p className="text-sm text-slate-300">
                  Define role names the way your company works, then map each one to an assessment basis.
                </p>
              </div>
              ...
              <div className="space-y-4 rounded-[22px] border border-white/10 bg-black/20 p-4">
                ...
                <label className="grid gap-1">
                  ...
                  <select
                    ...
                    className="rounded-[18px] border border-white/16 bg-white/[0.05] px-4 py-3 text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300/80"
                  >
                    {Object.entries(basisLabels).map(([value, basisLabel]) => (
