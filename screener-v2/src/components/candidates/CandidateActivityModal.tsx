    ...
    <>
      <div className="space-y-3">
        ...
        {items.length === 0 ? (
          ...
          <div className="rounded-[18px] bg-[color:var(--app-surface-soft)] p-4 ring-1 ring-[color:var(--app-border)]">
            ...
            <p className="mt-3 text-sm text-[color:var(--app-heading)]">
              {latestItem ? latestItem.title : "Activity feed is ready when you need it."}
            </p>
            {latestItem ? <p className="mt-1 text-sm leading-6 text-[color:var(--app-muted)]">{latestItem.detail}</p> : null}
          </div>
        )}
      </div>
