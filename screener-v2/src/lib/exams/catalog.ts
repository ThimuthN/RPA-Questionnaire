...
export const examCatalog: Record<ExamDefinitionId, ExamDefinitionCatalogEntry> = {
  core_exam: {
    ...
    panelClass: "border-brand-300/25 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--app-brand)_10%,var(--app-surface)),color-mix(in_srgb,var(--app-surface-soft)_96%,white))]",
  ...
  applied_logic_exam: {
    ...
    panelClass: "border-purple-400/25 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--pill-purple-bg)_92%,var(--app-surface)),color-mix(in_srgb,var(--app-surface-soft)_96%,white))]",
    configFields: [],
    defaultWeight: 20,
    defaultConfig: {},
    buildDurationMinutes: () => 10,
  ...
  general_capability_exam: {
    ...
    panelClass: "border-amber-400/25 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--pill-amber-bg)_92%,var(--app-surface)),color-mix(in_srgb,var(--app-surface-soft)_96%,white))]",
    configFields: [],
    defaultWeight: 30,
    defaultConfig: {},
    buildDurationMinutes: () => 30,
