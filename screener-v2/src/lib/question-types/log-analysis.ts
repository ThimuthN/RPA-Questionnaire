...
export const logAnalysisDef: QuestionTypeDef<any, number, { lines: string[] }> = {
  type: "log_analysis_single_select",
  runtimeLabel: "Log analysis",
  runtimeHint: "Base your answer on the log evidence only.",
