...
export const traceExecutionDef: QuestionTypeDef<any, number, { lines: string[] }> = {
  type: "trace_execution",
  runtimeLabel: "Trace execution",
  runtimeHint: "Follow the sequence and pick the final outcome.",
